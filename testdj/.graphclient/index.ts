...
import type { TestdjTypes } from './sources/testdj/types';
import * as importedModule$0 from "./sources/testdj/introspectionSchema";
...
export type MeshContext = TestdjTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/testdj/introspectionSchema":
...
const testdjTransforms = [];
const additionalTypeDefs = [] as any[];
const testdjHandler = new GraphqlHandler({
              name: "testdj",
              config: {"endpoint":"https://api.studio.thegraph.com/query/68248/testdj/v0.0.1"},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("testdj"),
              logger: logger.child("testdj"),
              importFn,
            });
sources[0] = {
          name: 'testdj',
          handler: testdjHandler,
          transforms: testdjTransforms
        }
