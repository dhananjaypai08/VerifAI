  ...
  const connectWallet = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        setMints(mints);
        const endorsements_total =
          await contractwithsigner.total_endorsements();
        ...
        for (var i = 0; i < nfts.length; i++) {
          ...
          nft_datas.push({
            ...
            image: nftipfsAddress + nfts[i].imageuri,
          });
        ...
        const endorsed_nfts = await contractwithsigner.getTokenIdAccountSharing(
          account
        );
        let endorsed = [];
        let endorsed_ipfs = [];
        for (var i = 0; i < endorsed_nfts.length; i++) {
          ...
          endorsed.push({
            name: endorsed_nfts[i].name,
            description: endorsed_nfts[i].description,
            image: nftipfsAddress + endorsed_nfts[i].imageuri,
          });
    ...
    <div className="main">
      ...
      <div className="home-container">
        <Helmet>
          ...
          <link
            href="https://db.onlinewebfonts.com/c/974bd878107a4b17fbb34db4029679e9?family=Clepto+Regular"
            rel="stylesheet"
          ></link>
        </Helmet>
        <header data-thq="thq-navbar" className="home-navbar">
          ...
          <div data-thq="thq-navbar-btn-group" className="home-btn-group">
            <button
              onClick={checkConnectionBeforeConnecting}
                ...
                nft_data.map((nft, index) => (
                  <>
                    <div
                      ...
                      key={index}
                    >
                      <li className="home-paragraph">
                        {nft.name}: <br></br>
                        {nft.description}
                        <img src={nft.image} className="home-image06"></img>
                      </li>
                      {ipfs_hash !== get_nft_cids[index] && (
                        <button
          ...
          <ul className="home-cards">
            {verified == true && (
              <div className="home-card">
                <li className="home-paragraph">
                  The NFT with tokenId: {verifiedURI} is <h3>verified</h3>
                  Name: {verifiedData["name"]} <br></br> Description:{" "}
                  {verifiedData["description"]} <br></br> TokenId:{" "}
            ...
            {verified == false && (
              <div className="home-card" style={{ width: 700 }}>
                <li className="home-paragraph">
                  The NFT with Hash: {verifiedURI} is <h3>NOT Verified</h3>
                </li>
              </div>
            )}
          </ul>
            ...
            <div className="home-heading">
              <h1 className="home-header">
                ...
                <span class="typing-text">
                  <span class="verifai">VerifAI</span>
                </span>
              </h1>
              <p className="home-caption">
                Where Blockchain Meets AI to Protect and Validate Content
        ...
        {/* <section className="home-container">
          ...
          Your DeCAT Profile:
              ...
              <label className="home-button7 button">
                Total DeCAT Sharings allowed: {endorsementsAllowed}
              </label>
              <label className="home-button7 button">
                DeCAT SBT's minted to your account
              </label>
              <ul>
                {fetched_nftdata &&
                  nft_data.map((nft, index) => (
            ...
            <div className="home-branding">
              <div className="home-heading10">
                ...
                <p className="home-caption17">
                  Empower your professional journey with VerifAI. Let's build a
